...
template_anomaly = 'The brand of the vehicle is ${Maker}. ' \
                 ...
                 'The date the vehicle broke down is ${breakdown_date}. ' \
                 'The complexity of repair the issue with the vehicle is ${repair_complexity}. ' \
                 'The hours taken to repair the issue with the vehicle is ${repair_hours}. ' \
                 'The cost to repair the issue with the vehicle is ${repair_cost}. ' \
